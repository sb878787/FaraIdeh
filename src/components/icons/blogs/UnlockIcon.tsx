interface IUnlockIconProps {
  size?: string;
  className?: string;
}

const UnlockIcon = ({ size = '19', className }: IUnlockIconProps) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <g clipPath="url(#clip0_939_924)">
        ...
        />
        <path
          d="M4 6.66666V5.33333C4 3.12419 5.79086 1.33333 8 1.33333C9.86387 1.33333 11.4299 2.6081 11.874 4.33333"
          stroke="currentColor"
          strokeWidth="1"
          strokeLinecap="round"
        />
